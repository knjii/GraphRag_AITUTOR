...
base = {'image','table','equation'}
extended = {'image','chart','table','equation'}
print('BASE_SPECIAL_COUNT', sum(1 for b in blocks if str(b.get('type','')) in base))
print('EXT_SPECIAL_COUNT', sum(1 for b in blocks if str(b.get('type','')) in extended))
print('chart_count', ctr.get('chart',0))
