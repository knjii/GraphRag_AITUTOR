...
Версии расходятся: в TRL 1.13 удалён `max_prompt_length`, а `vllm_mode`
и `vllm_enable_sleep_mode` появились только в 1.x (задачи 014, 017).
Лишнее поле — падение конструктора на оплаченной карте.
"""
